...
import com.autotownmayor.server.utils.RecaptchaUtil;
...
// Took code sample from https://dzone.com/articles/using-google-recaptcha-with-spring-boot-applicatio

@Service
public class RecaptchaService {

    @Value("${grecaptcha.secret}")
